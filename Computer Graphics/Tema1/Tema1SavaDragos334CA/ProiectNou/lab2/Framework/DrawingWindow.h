...
public:
	...
	static void addObject2D(Spaceship *s);
	...
	static void addObject2D_to_Visual2D(Spaceship *s, Visual2D *v);
	static void addObject2D_to_Visual2D(Enemy *e, Visual2D *v);
	...
	static void removeEnemy_from_Visual2D(Enemy *e, Visual2D *v);
