...
public class AsistentWindow implements EventHandler<Event> {

    private Stage applicationStage;
    private Scene applicationScene;

    private ArrayList<AsistentTableManagement> databaseManagementControllers;
    ...
    public void start() {
        ...
        try {
            ...
            applicationScene = new Scene((Parent) FXMLLoader.load(getClass().getResource(Constants.ASISTENT_FXML)));
                                    ...
                                    if (tab.getText().equals(newTab.getText())) {
                                        try {
                                            ...
                                            if (!databaseManagementControllers.isEmpty()) {
                                            	AsistentTableManagement currentTableManagementController = databaseManagementControllers.get(currentIndex);
                                                if (Constants.DEBUG) {
            ...
            Platform.runLater(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!tabExists) {
                        ...
                        AsistentTableManagement databaseManagementController = new AsistentTableManagement(Utilities.menuEntryToTableName(menuEntry));
