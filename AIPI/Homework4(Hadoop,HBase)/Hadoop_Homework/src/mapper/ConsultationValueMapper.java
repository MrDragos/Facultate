...
public class ConsultationValueMapper extends TableMapper<Text, Text> {
	...
	public void map(ImmutableBytesWritable investigationsId, Result investigationValue, Context context)
			...
			org.apache.hadoop.hbase.client.Get get = new org.apache.hadoop.hbase.client.Get(medicalServiceId.getBytes());
