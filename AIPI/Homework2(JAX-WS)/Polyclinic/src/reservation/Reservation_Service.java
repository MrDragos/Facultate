 ...
 * 
 */
@WebServiceClient(name = "Reservation", targetNamespace = "http://reservation/", wsdlLocation = "http://localhost:8080/reservation/Reservation?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATION_QNAME = new QName("http://reservation/", "Reservation");
    ...
    public Reservation getReservationPort() {
        return super.getPort(new QName("http://reservation/", "ReservationPort"), Reservation.class);
    }
    ...
    public Reservation getReservationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://reservation/", "ReservationPort"), Reservation.class, features);
    }
