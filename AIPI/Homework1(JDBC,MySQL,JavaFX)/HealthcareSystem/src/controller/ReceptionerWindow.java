...
public class ReceptionerWindow implements EventHandler<Event> {
    ...
    public void start() {
        ...
        try {
            ...
            applicationScene = new Scene((Parent) FXMLLoader.load(getClass().getResource(Constants.RECEPTIONER_FXML)));
    ...
    private void initialize() {
        try {
            ...
            //for (String tableName : tableNames) {
                ...
                menuItem = new MenuItem(Utilities.tableNameToMenuEntry("reservation"));
                menuItem.addEventHandler(EventType.ROOT, (EventHandler<Event>) this);
                databaseManagementMenu.getItems().add(menuItem);
            //}
        ...
        if (event.getSource() instanceof MenuItem) {
            Platform.runLater(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!tabExists) {
                        FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource(Constants.RECEPTIONER_TABLE_MANAGEMENT_FXML));
