...
namespace lab{
	...
	void loadObj(const std::string &filename, unsigned int &vao, unsigned int& vbo, unsigned int &ibo, unsigned int &num_indices,int type){
		...
		//restul case-urilor sunt pentru cei 6 posibili jucatori
		//dintre care noi vom alege doar 3

			case 1:{
				for (int i = 0; i < vertices.size(); i++){
					
					vertices[i].normal_x = 0.75 + 0.25*vertices[i].texcoord_x;
					vertices[i].normal_y = 0.80*vertices[i].texcoord_y;
					vertices[i].normal_z = 0.05*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);

					//vertices[i].normal_x = 0.25*vertices[i].texcoord_x;
					//vertices[i].normal_y = 0.50*vertices[i].texcoord_y;
					//vertices[i].normal_z = 0.95+0.05;//0.05*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
			...
			case 2:{
					   for (int i = 0; i < vertices.size(); i++){
						   ...
						   vertices[i].normal_x = 0.85 + 0.15*vertices[i].texcoord_x;
						   vertices[i].normal_y = 0.25*vertices[i].texcoord_y;
						   vertices[i].normal_z = 0.05*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);

						   //vertices[i].normal_x = 0.10*vertices[i].texcoord_x;;
						   //vertices[i].normal_y = 0.10*vertices[i].texcoord_y;;
						   //vertices[i].normal_z = 0.10*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);;
					   }
			};
			break;
			...
			case 3:{
					   for (int i = 0; i < vertices.size(); i++){
						  ...
						  // vertices[i].normal_x = 0.15*vertices[i].texcoord_x;
						   //vertices[i].normal_y = 0.15*vertices[i].texcoord_y;
						   //vertices[i].normal_z = 0.85+0.15*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);

						   vertices[i].normal_x = 0.75 + 0.25*vertices[i].texcoord_x;
						   vertices[i].normal_y = 0.20+ 0.25*vertices[i].texcoord_y;
						   vertices[i].normal_z = 0.05*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
					   

						  // vertices[i].normal_x = 0.70 + 0.25*vertices[i].texcoord_x;
						  // vertices[i].normal_y = 0.45 + 0.25*vertices[i].texcoord_y;
						  // vertices[i].normal_z = 0.5*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
			...
			case 4:{
					   for (int i = 0; i < vertices.size(); i++){
						   ...
						   vertices[i].normal_x = 0.85+0.15*vertices[i].texcoord_x;
						   vertices[i].normal_y = 0.60 + 0.40*vertices[i].texcoord_y;
						   vertices[i].normal_z = 0.25*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
			...
			case 5:{
					   for (int i = 0; i < vertices.size(); i++){
						   ...
						   vertices[i].normal_x = 0.70 + 0.25*vertices[i].texcoord_x;
						   vertices[i].normal_y = 0.45+0.25*vertices[i].texcoord_y;
						   vertices[i].normal_z = 0.15+0.25*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
			...
			case 6:{
					   for (int i = 0; i < vertices.size(); i++){
						   ...
						   vertices[i].normal_x = 0.25*vertices[i].texcoord_x;
						   vertices[i].normal_y = 0.75 + 0.25*vertices[i].texcoord_y;;
						   vertices[i].normal_z = 0.25*cos(vertices[i].texcoord_x + vertices[i].texcoord_y);
			...
			case 7:{
					   ...
					   for (int i = 0; i < vertices.size(); i++){
						   ...
						   vertices[i].normal_x = 0;
						   vertices[i].normal_y = 0;
						   vertices[i].normal_z = 0;

						   //vertices[i].normal_x = 0.15*vertices[i].texcoord_x;
						   //vertices[i].normal_y = 0.15*vertices[i].texcoord_y;
						   //vertices[i].normal_z = 0.15*vertices[i].texcoord_x + vertices[i].texcoord_y;
